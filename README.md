...
| scoring_player_id | integer | The API id of the player who scored the goal.                     |
| scoring_player_total | integer | The number of goals recorded by the scoring player this season.     |
| assist1_player_id | integer | The API id of the player who had the primary assist.              |
| assist1_player_total | integer | The number of assists recorded by the primary assist player this season.     |
| assist2_player_id | integer | The API id of the player who had the secondary assist.              |
